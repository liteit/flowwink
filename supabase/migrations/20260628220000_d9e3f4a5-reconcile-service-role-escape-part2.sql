-- Reconcile the skipped service_role-escape patch class (part 2 of 2).
--
-- OpenClaw QA proved create_manual_subscription + create_payroll_run were
-- uncallable by the autonomous operator because their service_role-escape
-- guard lived in backdated migrations (20260610113000 / 20260610120000 /
-- 20260610130000) that the dev ledger skipped. Those same two migrations
-- patched 42 more admin functions (manufacturing/MO, picking & shipping,
-- stock reservations, procurement, webinars, payroll, fixed assets, FX,
-- accounting-period locks, timesheets, dunning, vacation, subscriptions) with
-- the identical widening:
--     (auth.role() = 'service_role' OR has_role(auth.uid(), <role>))
-- so an agent calling via the service key (auth.uid() = NULL) is allowed.
--
-- This migration carries the LATEST definition of each of those 42 functions
-- (verbatim from the repo migration history — newest version per function,
-- so nothing is regressed), forward-dated + idempotent so the Lovable runner
-- applies it. create_manual_subscription/create_payroll_run already shipped in
-- 20260628210000 and are intentionally excluded here.


-- approve_payroll_run  (from 20260610120000_295e81a3-4a7f-47f6-93cc-c23ac20fba65.sql)
...
-- dispose_fixed_asset  (from 20260610130000_966682fa-c17b-4ef6-875d-f7968ccfebc5.sql)
...
-- list_payroll_lines  (from 20260610120000_295e81a3-4a7f-47f6-93cc-c23ac20fba65.sql)
...
-- list_payroll_runs  (from 20260610120000_295e81a3-4a7f-47f6-93cc-c23ac20fba65.sql)
...
-- mark_payroll_paid  (from 20260610120000_295e81a3-4a7f-47f6-93cc-c23ac20fba65.sql)
...
-- register_fixed_asset  (from 20260610130000_966682fa-c17b-4ef6-875d-f7968ccfebc5.sql)
...
-- revalue_open_balances  (from 20260615211957_cd170059-fdd3-4481-98fa-bac8893d1325.sql)
...
-- run_monthly_depreciation  (from 20260610130000_966682fa-c17b-4ef6-875d-f7968ccfebc5.sql)
...
-- set_exchange_rate  (from 20260610120000_295e81a3-4a7f-47f6-93cc-c23ac20fba65.sql)
...
-- adjust_quant  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- allocate_picking  (from 20260615221408_c2255642-7be4-47e4-8f42-9dd98e9040a8.sql)
...
-- approve_procurement_suggestion  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- auto_allocate_vacation  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- auto_generate_purchase_orders  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- bulk_invoice_from_timesheets  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- cancel_manual_subscription  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- cancel_mo  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- cancel_picking  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- cancel_reservation  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- cancel_webinar  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- close_accounting_period  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- complete_mo  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- complete_webinar  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- confirm_mo  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- consume_reservation  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- create_bom  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- generate_subscription_invoice  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- hire_application  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- lock_timesheet_period  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- mark_webinar_attendance  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- procurement_run  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- publish_webinar  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- reject_procurement_suggestion  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- reopen_accounting_period  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- reserve_stock  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- reset_module_data  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- send_dunning_reminders  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- ship_picking  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- start_mo  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- start_webinar  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- transfer_stock  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
...
-- trigger_procurement_for_mo  (from 20260610113000_63c878fc-caf0-43c8-ab4e-7e8d9c67a983.sql)
