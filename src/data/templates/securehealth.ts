...
import { securehealthBlogPosts } from '../template-blog-posts';
import { securehealthKbCategories } from '../template-kb-articles';

const securehealthPages: StarterTemplate['pages'] = [
  {
    title: 'Home',
    slug: 'home',
    isHomePage: true,
    ...
    blocks: [
      ...
      { id: 'link-grid-1', type: 'link-grid', data: { columns: 3, links: [{ icon: 'Calendar', title: 'Book Appointment', description: 'Schedule your visit online', url: '/book' }, { icon: 'MapPin', title: 'Find Us', description: 'Locations & directions', url: '/about' }, { icon: 'Phone', title: 'Urgent Care', description: '24/7 medical helpline', url: '/contact' }] } },
      { id: 'stats-1', type: 'stats', data: { title: 'Why Patients Trust Us', stats: [{ value: '98%', label: 'Patient Satisfaction', icon: 'Heart' }, { value: '<15min', label: 'Average Wait Time', icon: 'Clock' }, { value: '25+', label: 'Specialists On Staff', icon: 'UserCheck' }, { value: '10K+', label: 'Patients Annually', icon: 'Users' }] } },
      { id: 'chat-launcher-home', type: 'chat-launcher', data: { title: 'Questions? Ask Our Private AI', subtitle: 'HIPAA-compliant – your data never leaves our servers', placeholder: 'Ask about services, booking, or patient resources...', showQuickActions: true, quickActionCount: 4, variant: 'card' } },
      {
      ...
      },
      {
        ...
        data: {
          ...
          testimonials: [
            { id: 't1', content: 'The care I received was exceptional. The staff was attentive and the AI assistant helped me find the right specialist quickly.', author: 'Maria S.', role: 'Patient', rating: 5 },
            { id: 't2', content: 'I was hesitant about using an AI for health questions, but knowing that my data stays private made all the difference.', author: 'Rebecca M.', role: 'Patient', rating: 5 },
            { id: 't3', content: 'Booking appointments is so easy now. The whole experience feels modern while still being personal and caring.', author: 'David L.', role: 'Patient', rating: 5 },
          ],
          layout: 'carousel',
          columns: 3,
          showRating: true,
      ...
      },
      {
        ...
        data: {
          backgroundImage: '/templates/misc/hospital.jpg',
      ...
      },
      {
        ...
        data: {
          ...
          tabs: [
            { id: 'tab-primary', label: 'Primary Care', content: { type: 'doc', content: [{ type: 'heading', attrs: { level: 3 }, content: [{ type: 'text', text: 'General Medicine' }] }, { type: 'paragraph', content: [{ type: 'text', text: 'Routine checkups, preventive care, and treatment for common illnesses. Our primary care physicians are your first point of contact for all health concerns.' }] }, { type: 'bulletList', content: [{ type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Annual health screenings' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Chronic disease management' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Vaccinations and immunizations' }] }] }] }] } },
            { id: 'tab-specialists', label: 'Specialists', content: { type: 'doc', content: [{ type: 'heading', attrs: { level: 3 }, content: [{ type: 'text', text: 'Expert Specialty Care' }] }, { type: 'paragraph', content: [{ type: 'text', text: 'Access to board-certified specialists across cardiology, orthopedics, neurology, and more. Coordinated care with your primary physician.' }] }, { type: 'bulletList', content: [{ type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Cardiology and heart health' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Orthopedics and sports medicine' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Neurology and mental health' }] }] }] }] } },
            { id: 'tab-emergency', label: 'Emergency Care', content: { type: 'doc', content: [{ type: 'heading', attrs: { level: 3 }, content: [{ type: 'text', text: '24/7 Emergency Services' }] }, { type: 'paragraph', content: [{ type: 'text', text: 'State-of-the-art emergency department with experienced trauma teams. Open 24 hours a day, 365 days a year.' }] }, { type: 'bulletList', content: [{ type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Immediate triage and assessment' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Advanced diagnostic imaging' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Trauma and critical care' }] }] }] }] } },
          ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: 'two-col-1', type: 'two-column', data: { eyebrow: 'SERVICES', title: 'Primary Care', titleSize: 'large', content: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Our primary care physicians provide comprehensive health management for patients of all ages. From annual wellness visits to managing chronic conditions, we\'re your first point of contact for all health concerns.' }] }, { type: 'bulletList', content: [{ type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Annual wellness exams' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Chronic disease management' }] }] }, { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Preventive screenings' }] }] }] }] }, imageSrc: '/templates/team/nurse.jpg', imageAlt: 'Doctor with patient', imagePosition: 'right' } },
      { id: 'info-box-1', type: 'info-box', data: { title: 'HIPAA Compliant • Your Data Stays Here', content: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Our Private AI runs entirely on our secure, HIPAA-compliant infrastructure. Your health information is never sent to external cloud services.' }] }] }, variant: 'success' } },
      { id: 'cta-1', type: 'cta', data: { title: 'Ready to Schedule?', subtitle: 'Book your appointment today.', buttonText: 'Book Now', buttonUrl: '/book', gradient: false } },
    ],
  },
  {
    title: 'About Us',
    ...
    blocks: [
      ...
      { id: 'stats-1', type: 'stats', data: { title: 'Our Credentials', stats: [{ value: '20+', label: 'Years of Experience', icon: 'Award' }, { value: 'Board', label: 'Certified Physicians', icon: 'ShieldCheck' }, { value: 'HIPAA', label: 'Full Compliance', icon: 'Lock' }, { value: '5-Star', label: 'Patient Rating', icon: 'Star' }] } },
      { id: 'team-1', type: 'team', data: { title: 'Meet Our Doctors', subtitle: 'Board-certified specialists dedicated to your care.', members: [{ id: 'm1', name: 'Dr. Sofia Berg', role: 'Medical Director', bio: 'Board-certified in Internal Medicine with 20+ years of experience.', photo: '/templates/team/doctor-woman.jpg' }, { id: 'm2', name: 'Dr. James Wilson', role: 'Cardiologist', bio: 'Specialist in cardiovascular health and preventive care.', photo: '/templates/team/doctor-man.jpg' }, { id: 'm3', name: 'Dr. Emily Chen', role: 'Pediatrician', bio: 'Caring for children of all ages with a gentle approach.', photo: '/templates/team/doctor-woman-2.jpg' }, { id: 'm4', name: 'Dr. Michael Torres', role: 'Mental Health', bio: 'Psychiatrist specializing in anxiety and depression.', photo: '/templates/team/doctor-man-2.jpg' }], columns: 4, layout: 'grid', variant: 'cards', showBio: true, showSocial: false } },
    ],
  },
  {
      ...
      { id: 'chat-1', type: 'chat-launcher', data: { title: 'Private AI Health Assistant', subtitle: 'HIPAA-compliant — all conversations stay private', placeholder: 'Ask about appointments, services, or health information...', showQuickActions: true, quickActionCount: 4, variant: 'card' } },
      {
        ...
        data: {
          ...
          items: [
            ...
            { question: 'Where are you located?', answer: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'We have multiple locations throughout the region. Each facility features free parking and full accessibility.' }] }] }, image: '/templates/misc/hospital.jpg', imageAlt: 'Modern medical facility' },
          ],
        },
      },
      { id: 'info-box-1', type: 'info-box', data: { title: 'Patient Portal', content: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Access your medical records, test results, and appointment history securely online. All data is encrypted and stored on our HIPAA-compliant servers.' }] }] }, variant: 'default' } },
    ],
  },
  {
    ...
    menu_order: 5,
    showInMenu: true,
    meta: { description: 'Schedule your appointment online with our easy booking system', showTitle: false, titleAlignment: 'center' },
    blocks: [
      { id: 'hero-1', type: 'hero', data: { title: 'Book Your Appointment', subtitle: 'Choose your service, pick a time that works for you, and we\'ll take care of the rest.', backgroundType: 'image', backgroundImage: '/templates/misc/medical-tech.jpg', heightMode: '60vh', contentAlignment: 'center', overlayOpacity: 55, titleAnimation: 'fade-in' } },
      { id: 'features-1', type: 'features', data: { title: 'How It Works', features: [{ id: 'f1', icon: 'ClipboardList', title: '1. Choose Service', description: 'Select the type of appointment you need.' }, { id: 'f2', icon: 'Calendar', title: '2. Pick a Time', description: 'Let us know your preferred date and time.' }, { id: 'f3', icon: 'CircleCheck', title: '3. Confirmation', description: 'We\'ll call to confirm your appointment.' }], columns: 3, layout: 'grid', variant: 'centered', iconStyle: 'circle' } },
      { id: 'booking-1', type: 'booking', data: { title: 'Book Your Appointment', description: 'Select a service and choose an available time slot.', mode: 'smart', submitButtonText: 'Confirm Appointment', successMessage: 'Your appointment is booked! Check your email for confirmation.', showPhoneField: true, triggerWebhook: true, variant: 'card' } },
      { id: 'info-box-1', type: 'info-box', data: { title: 'What to Bring', content: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Please bring your insurance card, a valid ID, and a list of current medications. New patients should arrive 15 minutes early to complete paperwork.' }] }] }, variant: 'info' } },
      {
        id: 'accordion-1',
        type: 'accordion',
        data: {
      ...
      { id: 'contact-1', type: 'contact', data: { title: 'Prefer to Call?', phone: '+1 (555) 234-5678', email: 'appointments@securehealth.com', hours: [{ day: 'Booking Line', time: 'Mon-Fri 7AM-7PM' }, { day: 'Urgent Care', time: '24/7 Available' }] } },
    ],
  },
  {
    title: 'Contact',
    ...
    blocks: [
      ...
      { id: 'booking-1', type: 'booking', data: { title: 'Book an Appointment', description: 'Select a service and choose your preferred time.', mode: 'smart', submitButtonText: 'Confirm Appointment', successMessage: 'Your appointment is confirmed! Check your email for details.', showPhoneField: true, variant: 'card' } },
      { id: 'contact-1', type: 'contact', data: { title: 'Contact Information', phone: '+1 (555) 234-5678', email: 'care@securehealth.com', address: '200 Medical Center Drive, Suite 100, Boston, MA 02115', hours: [{ day: 'Monday - Friday', time: '7:00 AM - 7:00 PM' }, { day: 'Saturday', time: '8:00 AM - 4:00 PM' }, { day: 'Sunday', time: 'Closed (Urgent Care: 24/7)' }, { day: 'Emergency', time: 'Call 911 or (555) 234-5679' }] } },
      { id: 'info-box-1', type: 'info-box', data: { title: 'Emergency Care', content: { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'For medical emergencies, please call 911 immediately. For urgent but non-emergency concerns outside of office hours, call our 24/7 nurse line.' }] }] }, variant: 'warning' } },
    ],
  },
  {
    title: 'Patient FAQ',
    ...
    blocks: [
      ...
      { id: 'accordion-insurance', type: 'accordion', data: { title: 'Insurance & Billing', items: [
      ...
      { id: 'accordion-privacy', type: 'accordion', data: { title: 'Privacy & Records', items: [
      ...
      { id: 'accordion-services', type: 'accordion', data: { title: 'Services & Care', items: [
      ...
      { id: 'cta-faq', type: 'cta', data: { title: 'Still Have Questions?', subtitle: 'Our care team is here to help. Contact us or use our AI assistant.', buttonText: 'Contact Us', buttonUrl: '/contact', gradient: false } },
    ],
  },
  {
...
export const securehealthTemplate: StarterTemplate = {
  ...
  headerSettings: {
    ...
    customNavItems: [
      ...
      {
        id: 'about-us', label: 'About', url: '/about', enabled: true,
        description: 'Learn about SecureHealth',
        children: [
          { id: 'our-team', label: 'Our Team', url: '/about', description: 'Meet our healthcare professionals', icon: '👥' },
          { id: 'locations', label: 'Locations', url: '/about', description: 'Find a clinic near you', icon: '📍' },
          { id: 'privacy-security', label: 'Privacy & Security', url: '/privacy-policy', description: 'How we protect your data', icon: '🔐' },
