    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          imageSrc: '/templates/misc/agency-team-frustrated.jpg',
      ...
      },
      {
        ...
        data: {
          ...
          features: [
            { id: 'f1', icon: 'LayoutTemplate', title: 'Visual Page Builder', description: '58+ blocks for any layout. Clients can edit, you control what they can touch.' },
