...
import { launchpadBlogPosts } from '../template-blog-posts';
import { launchpadKbCategories } from '../template-kb-articles';

const launchpadPages: StarterTemplate['pages'] = [
  {
    title: 'Home',
    slug: 'home',
    isHomePage: true,
    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          subtitle: 'The all-in-one platform that turns your idea into a live product — in days, not months. Zero DevOps headaches, infinite scale.',
          backgroundType: 'video',
          videoType: 'direct',
          videoUrl: 'https://videos.pexels.com/video-files/3129671/3129671-uhd_2560_1440_30fps.mp4',
          videoPosterUrl: '/templates/blog/tech-network.jpg',
          videoLoop: true,
          videoMuted: true,
          heightMode: 'viewport',
      ...
      },
      {
        ...
        type: 'stats',
        data: {
          title: 'Built for Builders Who Move Fast',
          stats: [
            { value: '50K+', label: 'Active Users', icon: 'Users' },
            { value: '99.9%', label: 'Uptime SLA', icon: 'Shield' },
            { value: '120+', label: 'Integrations', icon: 'Plug' },
            { value: '<2min', label: 'Avg Deploy Time', icon: 'Zap' },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          items: [
            { id: 'ms1', text: 'Next.js', icon: '⚡' },
            { id: 'ms2', text: 'Stripe', icon: '💳' },
            { id: 'ms3', text: 'GitHub Actions', icon: '🔄' },
            { id: 'ms4', text: 'Vercel', icon: '▲' },
            { id: 'ms5', text: 'PostgreSQL', icon: '🗄️' },
            { id: 'ms6', text: 'Redis', icon: '🔴' },
            { id: 'ms7', text: 'OpenAI', icon: '🤖' },
            { id: 'ms8', text: 'Slack', icon: '💬' },
            { id: 'ms9', text: 'Zapier', icon: '⚙️' },
            { id: 'ms10', text: 'Twilio', icon: '📱' },
            { id: 'ms11', text: 'Datadog', icon: '📊' },
            { id: 'ms12', text: 'Figma', icon: '🎨' },
          ],
          speed: 'normal',
          direction: 'left',
        },
      },
      {
        ...
        data: {
          ...
          content: {
            type: 'doc',
            content: [
              { type: 'paragraph', content: [{ type: 'text', text: 'Your competitors are already shipping. Stop wrestling with infrastructure and start winning the market. Our platform gets your code to production in under 2 minutes — every single time.' }] },
              { type: 'bulletList', content: [
                { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'One-click deploys from Git to global edge' }] }] },
                { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Auto-scaling that handles 1M requests without a config change' }] }] },
                { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Built-in CDN across 47 global regions' }] }] },
              ]},
            ],
          },
          imageSrc: '/templates/misc/team-office.jpg',
      ...
      },
      {
        ...
        data: {
          ...
          subtitle: 'One platform. Every capability. No glue code.',
          variant: 'glass',
          items: [
      ...
      {
        id: 'parallax-momentum',
        type: 'parallax-section',
        data: {
          title: 'The Best Startups Don\'t Build Infrastructure. They Build Products.',
      ...
      },
      {
        ...
        data: {
          ...
          testimonials: [
            { id: 't1', content: 'We went from a Figma mockup to a live product serving real users in 11 days. LaunchPad killed every infrastructure excuse we had.', author: 'Sarah Chen', role: 'CTO', company: 'TechFlow', rating: 5 },
            { id: 't2', content: 'I\'ve worked at AWS, Heroku, and three Series B startups. This is the best developer experience I\'ve ever had — and I\'m not exaggerating.', author: 'Marcus Lindberg', role: 'Lead Engineer', company: 'InnovateCo', rating: 5 },
            { id: 't3', content: 'Our Black Friday campaign spiked to 80,000 concurrent users. Zero downtime, zero config changes. We literally just watched the revenue roll in.', author: 'Emily Rodriguez', role: 'Founder & CEO', company: 'GrowthLab', rating: 5 },
          ],
          layout: 'carousel',
          columns: 3,
          showRating: true,
      ...
      },
      {
        ...
        data: {
          title: 'Get the Edge',
          description: 'Weekly drops: product updates, growth tactics, and engineering insights used by the fastest-moving startups.',
          buttonText: 'Subscribe Free',
          successMessage: 'Welcome aboard! Check your inbox — something good is on the way.',
          variant: 'default',
          showNameField: false,
        },
      },
      {
        ...
        type: 'cta',
        data: {
          title: 'Your Next Big Thing Starts Today',
          subtitle: 'Free plan. No credit card. No BS. Just build.',
          buttonText: 'Start Building Free',
          buttonUrl: '/contact',
          gradient: true,
        },
    ...
    blocks: [
      ...
      },
      {
        ...
        data: {
          ...
          imageSrc: '/templates/blog/dashboard-costs.jpg',
