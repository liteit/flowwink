        ...
        // ─── 40+ MODULES — The Full ERP Stack ───
        {
          ...
          data: {
            ...
            features: [
              ...
              { id: 'mod-quotes', icon: 'FileSignature', title: 'Quotes', description: 'Quote templates, approval workflow, e-signature, automatic conversion to order.' },
              ...
              // ─ Operations ─
              { id: 'mod-projects', icon: 'KanbanSquare', title: 'Projects & Tasks', description: 'Kanban projects, task assignments, hourly rates, profitability per project.' },
              ...
              { id: 'mod-approvals', icon: 'CheckSquare', title: 'Approvals', description: 'Generic approval engine reused by expenses, leave, POs, contracts.' },
              // ─ Customer & Service ─
              ...
              // ─ Marketing & Content ─
              { id: 'mod-pages', icon: 'Layout', title: 'Pages & CMS', description: 'Visual page builder with 60+ block types. SEO metadata, scheduling, revisions.' },
              ...
              { id: 'mod-mcp', icon: 'Plug', title: 'MCP Server', description: 'Every module exposed as MCP tools. Connect Claude, Cursor, OpenClaw, GPT.' },
        ...
        // ─── COMPARISON — FlowWink vs incumbents ───
        {
          ...
          data: {
            ...
            rows: [
              ...
              ['Bring-your-own agent (Claude / GPT / OpenClaw)', '✅ Yes — admin chooses', '❌ No', '❌ No', '❌ No'],
      ...
      blocks: [
        ...
        // TWO-COLUMN — conversational service narrative
        {
          ...
          data: {
            ...
            imageUrl: '/templates/hero/data-abstract.jpg',
  ...
  products: [
    {
      ...
      currency: 'EUR',
      type: 'recurring',
      image_url: '/templates/products/code-screen.jpg',
      is_active: true,
    },
    {
      ...
      currency: 'EUR',
      type: 'recurring',
      image_url: '/templates/products/ai-concept.jpg',
      is_active: true,
    },
    {
      ...
      currency: 'EUR',
      type: 'one_time',
      image_url: '/templates/hero/ai-dark.jpg',
      is_active: true,
    },
    {
      ...
      currency: 'EUR',
      type: 'one_time',
      image_url: '/templates/products/laptop-work.jpg',
      is_active: true,
    },
  ],
  consultants: [
