      ...
      },
      {
        ...
        data: {
          ...
          features: [
            ...
            { id: 'f4', icon: 'Headphones', title: '24/7 Support', description: 'Our team is always here when you need us.' },
          ],
          columns: 4,
          layout: 'grid',
          variant: 'cards',
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            ...
            { id: 'bb6', icon: 'Headphones', title: 'Same-Day Response', description: 'Every message, email, and call answered within hours — not days. Your time matters.' },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            ...
            { id: 'p4', label: 'Project Success Rate', value: 92, color: 'hsl(47, 96%, 53%)', icon: 'CircleCheck' },
          ],
          variant: 'default',
          size: 'md',
          showPercentage: true,
      ...
      },
      {
        ...
        data: {
          ...
          features: [
            ...
            { id: 'f3', icon: 'Headphones', title: 'Ongoing Support', description: 'Our team is here for you before, during, and after your service.' },
          ],
          columns: 3,
          layout: 'grid',
          variant: 'cards',
...
const serviceProProducts: TemplateProduct[] = [
  {
    ...
    currency: 'USD',
    type: 'one_time',
    image_url: '/templates/blog/product-collection.jpg',
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    currency: 'USD',
    type: 'one_time',
    image_url: '/templates/misc/consultant-woman.jpg',
    is_active: true,
  },
  {
  ...
  },
  {
    ...
    currency: 'USD',
    type: 'one_time',
    image_url: '/templates/misc/our-team.jpg',
    is_active: true,
  },
];
