...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Pipelines", href: "/admin/pipelines", icon: FolderKanban, moduleId: "crm" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Approval Inbox", href: "/admin/approvals/inbox", icon: Inbox, moduleId: "approvals" },
      { name: "Approval Chains", href: "/admin/approvals/chains", icon: Network, moduleId: "approvals" },
