      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            notes: { type: 'string', description: 'Short internal note / metadata. NOT the agreement text — use body_markdown for that.' },
            body_markdown: { type: 'string', description: 'The FULL agreement text in Markdown (clauses, scope, payment terms, governing law, signatures section). REQUIRED for action=create unless a file_url is attached. Write the actual contract — do not leave empty.' },
            file_url: { type: 'string', description: 'Optional URL to an attached PDF/DOCX of the contract.' },
