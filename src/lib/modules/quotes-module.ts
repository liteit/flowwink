      ...
      function: {
        ...
        parameters: {
          ...
          properties: {
            ...
            items: {
              type: 'array',
              description: 'Create/update: line items in one call — [{description, quantity, unit_price_cents, tax_rate_pct?, discount_pct?, product_id?}]. Alternative to calling add_item repeatedly. On create you may instead pass a single line via the flat description/quantity/unit_price_cents fields below.',
              items: { type: 'object' },
            },
