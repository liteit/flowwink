    ...
    tool_definition: {
      ...
      function: {
        ...
        parameters: {
          ...
          required: ['action'],
          allOf: [
            { if: { properties: { action: { const: 'create' } } }, then: { required: ['action', 'title', 'customer_name'] } },
            { if: { properties: { action: { const: 'schedule' } } }, then: { required: ['action', 'id', 'scheduled_start', 'scheduled_end'] } },
            { if: { properties: { action: { const: 'complete' } } }, then: { required: ['action', 'id'] } },
            { if: { properties: { action: { const: 'cancel' } } }, then: { required: ['action', 'id'] } },
            { if: { properties: { action: { const: 'add_line' } } }, then: { required: ['action', 'id', 'description', 'quantity', 'unit_price'] } },
          ],
        },
      },
    },
